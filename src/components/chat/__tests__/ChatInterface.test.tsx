...
test("renders empty state with correct layout classes", () => {
  const { container } = render(<ChatInterface />);
  ...
  const emptyState = screen.getByText("Start a conversation to generate React components").closest(".flex-1");
